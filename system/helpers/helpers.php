...
{
    if($name === null){
    return isset($_SESSION['temporaray_errorFlash'])===true ? count($_SESSION['temporaray_errorFlash']) : false;
    }
    else
    {
        return isset($_SESSION['temporaray_errorFlash'])===true ? true : false;
